...
const resetPasswordRequest = async (req, res, next) => {
  try {
    ...
    const passwordResetLink = `https://stackmart.onrender.com/reset-password/${user._id}/${token}`;
    console.log(passwordResetLink);
    await transporter.sendMail({
      from: `"Stackmart" ${process.env.EMAIL_FROM}`, // sender address
